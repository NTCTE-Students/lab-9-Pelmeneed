...
<body class="max-w-6xl xl:mx-auto md:mx-10">
    ...
    <main class="mt-10 my-8 md:m-0 mx-8">
        ...
        <span class="ml-2 text-gray-600">(<?= (new Like())->getLikesCount('post', $post->getAttribute('id')) ?>)</span>
        <article>
                                ...
                                <?php if ($auth -> check()) { ?>
                                    <div>
                                        <div class="peer flex justify-between mt-4 space-x-4">
                                            ...
                                            <span class="text-gray-400 text-xs">(<?= (new Like())->getLikesCount('comment', $comment['id']) ?>)</span>
                                        </div>
                        ...
                        foreach ($inner_comments as $inner_comment) {
                            ...
                            <article class="p-6 mb-3 lg:ml-12 text-base">
                                ...
                                <div class="peer flex justify-end mt-4 space-x-4">
                                    ...
                                    <span class="text-gray-400 text-xs">(<?= (new Like())->getLikesCount('comment', $inner_comment['id']) ?>)</span>
                                </div>
                            </article>
                        <?php }
                    } ?>
